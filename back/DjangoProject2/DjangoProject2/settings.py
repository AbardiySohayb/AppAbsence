...
SECRET_KEY = 'django-insecure-_cc!i@k7#!zw!+yw4z@&iou_f&i0e3z*%v)(e56egsl8p!9!$3'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'AppKt',    # Nom de la base PostgreSQL
...
CORS_ALLOW_ALL_ORIGINS = True  # Attention : En production, vous devriez restreindre cela
